...
public final class SipManager {
     ...
     */
    public static final String INTENT_SIP_CONFIGURATION = "tw.net.ezcall.service.SipConfiguration";
    /**
     ...
     */
    public static final String INTENT_SIP_SERVICE = "tw.net.ezcall.service.SipService";
     ...
     * </p>
     */
    public static final String INTENT_SIP_ACCOUNT_ACTIVATE = "tw.net.ezcall.accounts.activate";
     ...
     * </p>
     */
    public static final String ACTION_SIP_CALL_UI = "tw.net.ezcall.phone.action.INCALL";
    /**
     * Action launched when the status icon clicked.<br/>
     * Should raise the dialer.
     */
    public static final String ACTION_SIP_DIALER = "tw.net.ezcall.phone.action.DIALER";
    /**
     * Action launched when a missed call notification entry is clicked.<br/>
     * Should raise call logs list.
     */
    public static final String ACTION_SIP_CALLLOG = "tw.net.ezcall.phone.action.CALLLOG";
    /**
     * Action launched when a sip message notification entry is clicked.<br/>
     * Should raise the sip message list.
     */
    public static final String ACTION_SIP_MESSAGES = "tw.net.ezcall.phone.action.MESSAGES";
    /**
     * Action launched when user want to go in sip favorites.
     * Should raise the sip favorites view.
     */
    public static final String ACTION_SIP_FAVORITES = "tw.net.ezcall.phone.action.FAVORITES";
    /**
     * Action launched to enter fast settings.<br/>
     */
    public static final String ACTION_UI_PREFS_FAST = "tw.net.ezcall.ui.action.PREFS_FAST";
    /**
     * Action launched to enter global csipsimple settings.<br/>
     */
    public static final String ACTION_UI_PREFS_GLOBAL = "tw.net.ezcall.ui.action.PREFS_GLOBAL";
     ...
     * </p>
     */
    public static final String ACTION_SIP_CALL_CHANGED = "tw.net.ezcall.service.CALL_CHANGED";
    /**
     ...
     * </p>
     */
    public static final String ACTION_SIP_ACCOUNT_CHANGED = "tw.net.ezcall.service.ACCOUNT_CHANGED";
    /**
     ...
     * </p>
     */
    public static final String ACTION_SIP_REGISTRATION_CHANGED = "tw.net.ezcall.service.REGISTRATION_CHANGED";
    /**
     * Broadcast sent when the state of device media has been changed.
     */
    public static final String ACTION_SIP_MEDIA_CHANGED = "tw.net.ezcall.service.MEDIA_CHANGED";
    /**
     * Broadcast sent when a ZRTP SAS
     */
    public static final String ACTION_ZRTP_SHOW_SAS = "tw.net.ezcall.service.SHOW_SAS";
    /**
     ...
     */
    public static final String ACTION_SIP_MESSAGE_RECEIVED = "tw.net.ezcall.service.MESSAGE_RECEIVED";
    /**
     ...
     * </p>
     */
    public static final String ACTION_SIP_CALL_RECORDED = "tw.net.ezcall.service.CALL_RECORDED";

    // REGISTERED BROADCASTS
    /**
     * Broadcast to send when the sip service can be stopped.
     */
    public static final String ACTION_SIP_CAN_BE_STOPPED = "tw.net.ezcall.service.ACTION_SIP_CAN_BE_STOPPED";
    /**
     * Broadcast to send when the sip service should be restarted.
     */
    public static final String ACTION_SIP_REQUEST_RESTART = "tw.net.ezcall.service.ACTION_SIP_REQUEST_RESTART";
    /**
     ...
     * @see #EXTRA_OUTGOING_ACTIVITY
     */
    public static final String ACTION_OUTGOING_UNREGISTER = "tw.net.ezcall.service.ACTION_OUTGOING_UNREGISTER";
    /**
     ...
     * @see #EXTRA_OUTGOING_ACTIVITY
     */
    public static final String ACTION_DEFER_OUTGOING_UNREGISTER = "tw.net.ezcall.service.ACTION_DEFER_OUTGOING_UNREGISTER";

    // PLUGINS BROADCASTS
    /**
     * Plugin action for themes.
     */
    public static final String ACTION_GET_DRAWABLES = "tw.net.ezcall.themes.GET_DRAWABLES";
    /**
     ...
     * </ul>
     */
    public static final String ACTION_GET_PHONE_HANDLERS = "tw.net.ezcall.phone.action.HANDLE_CALL";
     ...
     */
    public static final String ACTION_INCALL_PLUGIN = "tw.net.ezcall.sipcall.action.HANDLE_CALL_PLUGIN";
    
    public static final String EXTRA_SIP_CALL_MIN_STATE = "tw.net.ezcall.sipcall.MIN_STATE";
    public static final String EXTRA_SIP_CALL_MAX_STATE = "tw.net.ezcall.sipcall.MAX_STATE";
    public static final String EXTRA_SIP_CALL_CALL_WAY = "tw.net.ezcall.sipcall.CALL_WAY";
     ...
     * </ul>
     */
    public final static String ACTION_REWRITE_NUMBER = "tw.net.ezcall.phone.action.REWRITE_NUMBER"; 
    /**
     * Plugin action for audio codec.
     */
    public static final String ACTION_GET_EXTRA_CODECS = "tw.net.ezcall.codecs.action.REGISTER_CODEC";
    /**
     * Plugin action for video codec.
     */
    public static final String ACTION_GET_EXTRA_VIDEO_CODECS = "tw.net.ezcall.codecs.action.REGISTER_VIDEO_CODEC";
    /**
     * Plugin action for video.
     */
    public static final String ACTION_GET_VIDEO_PLUGIN = "tw.net.ezcall.plugins.action.REGISTER_VIDEO";
    /**
     ...
     */
    public static final String AUTHORITY = "tw.net.ezcall.db";
    /**
