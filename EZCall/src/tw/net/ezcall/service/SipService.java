...
import tw.net.ezcall.api.ISipConfiguration;
import tw.net.ezcall.api.ISipService;
import tw.net.ezcall.api.MediaState;
...
import tw.net.ezcall.api.SipMessage;
...
import tw.net.ezcall.pjsip.PjSipCalls;
import tw.net.ezcall.pjsip.PjSipService;
import tw.net.ezcall.pjsip.UAStateReceiver;
import tw.net.ezcall.service.receiver.DynamicReceiver4;
import tw.net.ezcall.service.receiver.DynamicReceiver5;
import tw.net.ezcall.ui.incall.InCallMediaControl;
...
import tw.net.ezcall.utils.ExtraPlugins.DynActivityPlugin;
...
//		connectivityManager = (ConnectivityManager) getSystemService(Context.CONNECTIVITY_SERVICE);
	...
	private void applyComponentEnablingState(boolean active) {
        ...
        ComponentName cmp = new ComponentName(this, "tw.net.ezcall.ui.PrivilegedOutgoingCallBroadcaster");
        try {
	...
	private synchronized void acquireResources() {
		...
		if (prefsWrapper.getPreferenceBooleanValue(SipConfigManager.USE_PARTIAL_WAKE_LOCK)) {
			...
			if (wakeLock == null) {
				wakeLock = pman.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "tw.net.ezcall.SipService");
		...
		if (wifiLock == null) {
			...
			wifiLock = wman.createWifiLock(mode, "tw.net.ezcall.SipService");
