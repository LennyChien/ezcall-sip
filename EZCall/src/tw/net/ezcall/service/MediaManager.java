...
import tw.net.ezcall.utils.Ringer;
import tw.net.ezcall.utils.accessibility.AccessibilityWrapper;
import tw.net.ezcall.utils.audio.AudioFocusWrapper;
import tw.net.ezcall.utils.bluetooth.BluetoothWrapper;
import tw.net.ezcall.utils.bluetooth.BluetoothWrapper.BluetoothChangeListener;
		...
		if(winfo != null) {
			...
			if(service.getPrefs().getPreferenceBooleanValue(SipConfigManager.KEEP_AWAKE_IN_CALL)) {
				if(screenLock == null) {
		            ...
		            screenLock = pm.newWakeLock(PowerManager.SCREEN_DIM_WAKE_LOCK | PowerManager.ON_AFTER_RELEASE, "tw.net.ezcall.onIncomingCall.SCREEN");
