...
import tw.net.ezcall.ui.outgoingcall.OutgoingCallChooser;
		...
		if (action.equals(Intent.ACTION_NEW_OUTGOING_CALL) ) {
			...
			if(prefsWrapper.isValidConnectionForOutgoing() || potentialHandlers.size() > 1) {
	            ...
	            if(gsmCallHandlerId == null) {
	                gsmCallHandlerId = CallHandlerPlugin.getAccountIdForCallHandler(aContext, (new ComponentName(aContext, tw.net.ezcall.plugins.telephony.CallHandler.class)).flattenToString());
	            }
				...
				Log.d(THIS_FILE, "Start outgoing call chooser for EZCall");
