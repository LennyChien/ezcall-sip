...
package tw.net.ezcall.ui.incall;
...
import tw.net.ezcall.ui.PickupSipUri;
import tw.net.ezcall.ui.incall.CallProximityManager.ProximityDirector;
import tw.net.ezcall.ui.incall.DtmfDialogFragment.OnDtmfListener;
import tw.net.ezcall.utils.CallsUtils;
...
import tw.net.ezcall.utils.keyguard.KeyguardWrapper;
import tw.net.ezcall.widgets.IOnLeftRightChoice;
import tw.net.ezcall.widgets.ScreenLocker;
    ...
    private void attachVideoPreview() {
        ...
        if(prefsWrapper.getPreferenceBooleanValue(SipConfigManager.USE_VIDEO)) {
            ...
            if(videoWakeLock == null) {
                videoWakeLock = powerManager.newWakeLock(PowerManager.SCREEN_BRIGHT_WAKE_LOCK | PowerManager.ACQUIRE_CAUSES_WAKEUP, "tw.net.ezcall.videoCall");
