...
package tw.net.ezcall.ui.dialpad;
...
import tw.net.ezcall.ui.SipHome.ViewPagerVisibilityListener;
import tw.net.ezcall.ui.dialpad.DialerLayout.OnAutoCompleteListVisibilityChangedListener;
import tw.net.ezcall.utils.CallHandlerPlugin;
import tw.net.ezcall.utils.CallHandlerPlugin.OnLoadListener;
import tw.net.ezcall.utils.DialingFeedback;
import tw.net.ezcall.utils.Log;
import tw.net.ezcall.utils.PreferencesWrapper;
import tw.net.ezcall.utils.Theme;
import tw.net.ezcall.utils.contacts.ContactsSearchAdapter;
import tw.net.ezcall.widgets.AccountChooserButton;
import tw.net.ezcall.widgets.AccountChooserButton.OnAccountChangeListener;
import tw.net.ezcall.widgets.DialerCallBar;
import tw.net.ezcall.widgets.DialerCallBar.OnDialActionListener;
import tw.net.ezcall.widgets.Dialpad;
import tw.net.ezcall.widgets.Dialpad.OnDialKeyListener;
    ...
    public void placeVMCall() {
        ...
        if (accountToUse >= 0) {
            ...
            if (!TextUtils.isEmpty(vmAcc.vm_nbr)) {
                ...
                (new ComponentName(getActivity(), tw.net.ezcall.plugins.telephony.CallHandler.class).flattenToString()))) {
            // Case gsm voice mail
