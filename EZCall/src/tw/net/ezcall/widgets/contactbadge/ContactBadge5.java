...
package tw.net.ezcall.widgets.contactbadge;
...
public class ContactBadge5 extends ContactBadgeContract {
    ...
    public ContactBadge5(Context context, AttributeSet attrs, int defStyle, tw.net.ezcall.widgets.contactbadge.QuickContactBadge topBadge) {
