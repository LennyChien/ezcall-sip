...
import tw.net.ezcall.utils.AccountListUtils;
import tw.net.ezcall.utils.AccountListUtils.AccountStatusDisplay;
...
public class AccountChooserButton extends LinearLayout implements OnClickListener {
    ...
    public AccountChooserButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        telCmp = new ComponentName(getContext(), tw.net.ezcall.plugins.telephony.CallHandler.class);
