...
package tw.net.ezcall.utils.bluetooth;
	...
	public static BluetoothWrapper getInstance(Context context) {
		if(instance == null) {
		    if(Compatibility.isCompatible(14)) {
		        instance = new tw.net.ezcall.utils.bluetooth.BluetoothUtils14();
		    }else if(Compatibility.isCompatible(8)) {
                instance = new tw.net.ezcall.utils.bluetooth.BluetoothUtils8();
			}else {
                instance = new tw.net.ezcall.utils.bluetooth.BluetoothUtils3();
			}
		    if(instance != null) {
