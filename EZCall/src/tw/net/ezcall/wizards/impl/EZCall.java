...
public class EZCall extends EZCallImplementation {
	...
	public void setDefaultParams(PreferencesWrapper prefs) {
		...
		// User agent -- useful?
		// prefs.setPreferenceStringValue(SipConfigManager.USER_AGENT,
		// "1WorldVoip");

		// Codecs -- Assume they have legal rights to provide g729 to each users
		// As they activate it by default in their forked app.
		// For Narrowband
		prefs.setCodecPriority("G729/8000/1", SipConfigManager.CODEC_NB, "250");
		prefs.setCodecPriority("iLBC/8000/1", SipConfigManager.CODEC_NB, "200");
		...
		// For Wideband
		prefs.setCodecPriority("G729/8000/1", SipConfigManager.CODEC_WB, "250");
