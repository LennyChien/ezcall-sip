...
public interface EZCallWizardIface {
	 ...
	 * 
	 * @param parent
	 *            The base preference container that is basically a preference
	 *            activity.
	 */
	void setParent(EZCallPrefsWizard parent);
	 ...
	 * 
	 * @param account
	 *            The account to fill information of.
	 */
	 ...
	 * 
	 * @param fieldName
	 *            the name of the field to retrieve summary of.
	 ...
	 * 
	 * @param account
	 *            The sip profile already saved in database
	 ...
	 * 
	 * @param prefs
	 *            The preference wrapper interface.
	 */
