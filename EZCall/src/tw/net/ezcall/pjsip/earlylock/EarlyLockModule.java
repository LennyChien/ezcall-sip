...
package tw.net.ezcall.pjsip.earlylock;
...
import tw.net.ezcall.pjsip.PjSipService.PjsipModule;
...
public class EarlyLockModule implements PjsipModule {
     ...
     * (non-Javadoc)
     * @see
     * tw.net.ezcall.pjsip.PjSipService.PjsipModule#setContext(android.content
     * .Context)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see tw.net.ezcall.pjsip.PjSipService.PjsipModule#onBeforeStartPjsip()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see tw.net.ezcall.pjsip.PjSipService.PjsipModule#
     * onBeforeAccountStartRegistration(int, tw.net.ezcall.api.SipProfile)
     */
    @Override
    ...
    private class WorkLocker extends Thread {
        ...
        WorkLocker(long time) {
            lockTime = time;
            wl = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "tw.net.ezcall.earlylock");
            wl.acquire();
        }
